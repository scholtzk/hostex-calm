...
export const CleanerManagement = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Current Cleaners ({cleaners.length})</CardTitle>
        </CardHeader>
        <CardContent>
          {cleaners.length === 0 ? (
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                          ...
                          <Dialog>
                            <DialogTrigger asChild>
                              <Button
                                variant="ghost"
                                size="sm"
                                onClick={() => handleWorkHistory(cleaner)}
                            ...
                            <DialogContent className="max-w-md">
                              ...
                              <div className="space-y-4">
                                ...
                                <Button 
                                  ...
                                  disabled={!selectedMonth || loadingHistory}
                                  className="w-full"
                                >
                              ...
                              <form onSubmit={handleEditSubmit} className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                  ...
                                  <div>
                                    ...
                                    <Input
                                      id="edit-flatRate"
                                      type="number"
                                      value={editForm.flatRate}
                                      onChange={(e) => setEditForm({...editForm, flatRate: e.target.value})}
                                      required
                                    />
                                  </div>
                                  <div className="md:col-span-2">
                                    ...
                                    <Input
                                      ...
                                      placeholder="deep-clean, laundry, bathroom-clean"
                                    />
                                  </div>
                                  <div className="md:col-span-2">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-1">
                                      Get this from LINE Developers Console when the cleaner adds your bot
                                    </p>
                                  </div>
                                </div>
                                <div className="flex justify-between items-center pt-4 border-t">
                                  <Button 
                                    ...
                                    variant="destructive" 
                                    size="sm"
                                    onClick={() => handleDelete(editingCleaner.id)}
                                  ...
                                  <div className="flex gap-2">
                                    <Button type="button" variant="outline" onClick={() => setEditingCleaner(null)}>
                                      Cancel
                                    </Button>
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-sm text-gray-600">¥{cleaner.flatRate}/job</p>
                        </div>
                      </div>
